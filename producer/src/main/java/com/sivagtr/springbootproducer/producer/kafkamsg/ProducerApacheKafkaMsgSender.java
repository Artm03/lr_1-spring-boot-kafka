...
public class ProducerApacheKafkaMsgSender {
	...
	private Properties getProperties(){
		...
		properties.put("ssl.truststore.location", "/Users/gavrilovartyo/keystore_reg.pfx");
		properties.put("ssl.truststore.password", "One_Minus_33");
		properties.put("ssl.keystore.location", "/Users/gavrilovartyo/keystore_reg.pfx");
		properties.put("ssl.keystore.password", "One_Minus_33");
		properties.put("ssl.key.password", "One_Minus_33");
